...
var debounce_1 = debounce$1;function useEventListener(target, event, handler) {
  if (vue.isRef(target)) {
    vue.watch(target, function (value, oldValue) {
...
var modifierPhases = [beforeRead, read, afterRead, beforeMain, main, afterMain, beforeWrite, write, afterWrite];function order(modifiers) {
  var map = new Map();
  var visited = new Set();
  var result = [];
...
var script = {
  ...
  setup: function setup(__props, _ref) {
    ...
    vue.watchEffect(function () {
      if (manualMode.value) {
        show.value ? delay(openDelay.value).then(open) : delay(closeDelay.value).then(close);
      }
    });
    /**
...
styleInject(css_248z);script.__scopeId = "data-v-214c8969";// IIFE injects install function into component, allowing component
