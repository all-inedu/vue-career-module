import { ref, onMounted, onUpdated, openBlock, createElementBlock, renderSlot, createElementVNode, withKeys, withModifiers, inject, mergeProps, Fragment, renderList, normalizeClass, toDisplayString, createCommentVNode, reactive, toRef, computed, watchEffect, defineComponent, getCurrentInstance, watch, nextTick, provide, resolveComponent, createVNode, withCtx, createBlock, withDirectives, vShow } from 'vue';
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , _hoisted_2$2), renderSlot(_ctx.$slots, "append")]);
}
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("ul", mergeProps({
    ...
    , _hoisted_2$1)) : createCommentVNode("v-if", true)], 64
    /* STABLE_FRAGMENT */
    );
  }), 128
  /* KEYED_FRAGMENT */
...
var _hoisted_6 = /*#__PURE__*/createElementVNode("span", {
  "class": "icon loading"
}, [/*#__PURE__*/createElementVNode("div"), /*#__PURE__*/createElementVNode("div"), /*#__PURE__*/createElementVNode("div")], -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["modelValue", "collapse-tags", "onClick"]), renderSlot(_ctx.$slots, "toggle", {
  ...
  /* NEED_PATCH */
  ), _ctx.multiple && _ctx.taggable && _ctx.searchable ? (openBlock(), createElementBlock("div", _hoisted_7, [withDirectives(createVNode(_component_v_input, {
    ref: "input",
    modelValue: _ctx.searchingInputValue,
